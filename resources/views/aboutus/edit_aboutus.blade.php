                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 offset-md-4">
                            <form action="{{ url('aboutus/' .$aboutus->id) }}" method="POST"}}>
                                @method('patch')
                                @csrf
                                <div class="form-group">
                                    <label>Ubah Deskripsi</label>
                                    <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" required>{{ old('deskripsi', $aboutus->deskripsi) }}</textarea>
                                    @error('deskripsi')
