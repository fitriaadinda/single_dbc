    ...
    <body>
        <div class="container-mobile">
            ...
            <div class="login-profile">
                <div class="logo logo--black">
                    <img src="{{ asset('dbc/assets/images/logo-login.svg') }}" class="img-fluid" />
                </div>

                <div class="login-profile__title">
                    Log In
                </div>

                <form class="form-signin" method="POST" action="{{ route('loginpengguna') }}">
                    {{ csrf_field() }}
                    <div class="form-group form__input">
                        <label for="email" class="form__input-label">Email</label>
                        <input type="email" name="email" id="inputEmail" class="form-control form__input-tag" placeholder="Email" required autofocus>
                    </div>
                    <div class="form-group form__input">
                        <label for="password" class="form__input-label">Password</label>
                        <input type="password" name="password" id="inputPassword" class="form-control form__input-tag" placeholder="Password" required>
                    </div>
                    <div class="form__button" style="margin: 20px 0;">
                        <button class="btn button button--grid-1" type="submit">Log In</button>
                    </div>
                </form>
                <p class="text-forgot">Forgot Password?<a class="click-here" href="">Click Here</a></p>
            </div>
        </div>
