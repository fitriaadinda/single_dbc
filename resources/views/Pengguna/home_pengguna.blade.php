        ...
        <div class="container-mobile">
            ...
            <div class="background">
                ...
                <div class="profile">
                    ...
                    <div class="profile__name">
                        <div class="profile__name-size">{{$pengguna->nama}}</div>
                    </div>
                    <div class="profile__position">{{$pengguna->role}}</div>
                    <div class="form__button">
                    <button class="btn button" type="submit" style="width: 130px;;">Chat Me  <i class="fa fa-paper-plane" aria-hidden="true"></i></button>
                    </div>
                    <div class="form__button">
                        <a href="{{ url('enter_room') }}"><button class="btn button" type="submit" style="width: 130px;">Enter Room</button></a>
                    </div>
                    <div class="form__button">
                        <a href="{{ url('commerce') }}"><button class="btn button" type="submit" style="width: 130px;">Commerce</button></a>
                    </div>
                </div>
                    ...
                    <div class="information__body-bar d-none">
                        <div class="information__body-bar-content">
                            ...
                            <div class="information__about-me">
                                ...
                                <div class="d-flex">
                                    <a href="https://www.instagram.com/{{ str_replace('@', '', $pengguna->instagram) }}" target="_blank">
                                    ...
                                    <a href="https://www.linkedin.com/in/{{$pengguna->linkedin}}" target="_blank">
                                        <div class="information__button-contact information__button-contact--ig rounded-circle">
                                            <img src= "{{ asset('dbc/assets/images/icon-linkedin.svg') }}" class="img-fluid" />
                                        </div>
                                    </a>
                                    <a href="http://line.me/ti/p/~{{$pengguna->line}}" target="_blank">
                                        <div class="information__button-contact information__button-contact--ig rounded-circle">
                        ...
                        <div class="information__qr-code d-none">
                            ...
                            {!! QrCode::size(296)->generate(url(str_replace(" ","","$pengguna->nama"))); !!}
                            <div style="margin-top: 30px">or Share With Link :</div>
                            <div class="information__qr-code-link">dbc.the-netwerk/{{str_replace(" ","","$pengguna->nama")}}</div>
                        </div>
                        <div class="information__button-bottom">
                            ...
                            <div class="information__button-bottom-bg d-flex">
                                <a href="{{ url('set_meeting') }}" class="btn button button--schedule-meeting">Schedule a Meeting</a>
            ...
            <div class="meeting d-none">
                ...
                <form method="post">
                    ...
                    <div class="d-flex">
                        <button class="btn button button--grey button--grid-2" type="button">Cancel</button>
