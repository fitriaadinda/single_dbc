                ...
                <form action="{{ url('Pengguna/' .$pengguna->id) }}" method="post">
                    ...
                    <div class="form__profile">
                        <div class="form__profile-image rounded-circle">
                            <img src="{{ asset('dbc/assets/images/profile.svg') }}" class="img-fluid" />
                        </div>
                    ...
                    <div class="form-group form__input">
                        ...
                        <input type="text" class="form-control form__input-tag @error('nama') is-invalid @enderror" value="{{ old('nama', $pengguna->nama) }}" id="nama" name="nama">
                    </div>
                    <div class="form-group form__input">
                        <label for="director" class="form__input-label">Tittle</label>
                        <input type="text" class="form-control form__input-tag @error('title') is-invalid @enderror" value="{{ old('title', $pengguna->role) }}" id="title" name="title" >
                    </div>
                    <div class="form-group form__input">
                        <label for="email" class="form__input-label">Email</label>
                        <input type="email" class="form-control form__input-tag @error('nama') is-invalid @enderror" value="{{ old('nama', $pengguna->email) }}" id="email" name="email">
                    </div>
                    <div class="form-group form__input">
                        <label for="phone" class="form__input-label">Phone</label>
                        <input type="text" class="form-control form__input-tag @error('nama') is-invalid @enderror" value="{{ old('nama', $pengguna->phone) }}" id="phone" name="phone">
                    </div>
                    <div class="form-group form__input">
                        <label for="link_room" class="form__input-label">Link Room</label>
                        <input type="text" class="form-control form__input-tag @error('nama') is-invalid @enderror" value="{{ old('nama', $pengguna->link_room) }}" id="link_room" name="link_room">
                    </div>
                    <div class="edit-profile__title">
                        Social
                    </div>
                    <div class="form-group form__input">
                        ...
                        <input type="text" class="form-control form__input-tag @error('nama') is-invalid @enderror" value="{{ old('nama', $pengguna->instagram) }}" id="instagram" name="instagram">
                    </div>
                    <div class="form-group form__input">
                        <label for="linkedIn" class="form__input-label">LinkedIn</label>
                        <input type="text" class="form-control form__input-tag @error('nama') is-invalid @enderror" value="{{ old('nama', $pengguna->linkedin) }}" id="linkedIn" name="linkedIn">
                    </div>
                    <div class="form-group form__input">
                        <label for="line" class="form__input-label">Line</label>
                        <input type="text" class="form-control form__input-tag @error('nama') is-invalid @enderror" value="{{ old('nama', $pengguna->line) }}" id="line" name="line">
                    </div>
                    <div class="form__button" style="margin: 20px 0;">
